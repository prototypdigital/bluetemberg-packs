...
const PROFILES = {
  ...
  'bluetemberg-agents-docs-maintainer':            { universal: false, profiles: ['frontend', 'backend', 'fullstack', 'devops', 'pure-infra'] },
  ...
  'bluetemberg-skills-docs-upkeep':                { universal: false, profiles: ['frontend', 'backend', 'fullstack', 'devops', 'pure-infra'] },
  'bluetemberg-skills-workspace-hygiene':          { universal: false, profiles: ['frontend', 'backend', 'fullstack', 'devops', 'pure-infra'] },
